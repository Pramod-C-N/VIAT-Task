...
@Component({
  selector:'createoreditcustomer',
  templateUrl: './createCustomers.component.html',
...
export class CreateCustomerComponent extends AppComponentBase {
  ...
  Validators.pattern("^3[0-9]*3$")]]        
    ...
    this.commonForm.get('profileType').valueChanges.subscribe(val => {
      ...
      if (this.commonForm.get('profileType').value == "Individual") { 
    ...
    isFormValid() {
      ...
      if (this.profileType == "Individual") {
        console.log(this.individualRequiredForm.valid , this.addressRequiredForm.valid )

        return this.individualRequiredForm.valid && this.addressRequiredForm.valid;
      } else {
        console.log(this.companyRequiredForm.valid , this.addressRequiredForm.valid , this.individualRequiredForm.valid)
