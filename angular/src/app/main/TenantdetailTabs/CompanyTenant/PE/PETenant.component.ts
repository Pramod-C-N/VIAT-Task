...
@Component({
    selector: 'PETenant',
    templateUrl: './PETenant.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class PETenantComponent extends AppComponentBase {
    ...
    ngOnInit() {
        ...
        this.tenants.constitutionType = 'Permanent Establishment';
...
additem(){
   ...
   deleteItem(index: number) {
    this.Documentitems.splice(index, 1);
          ...
          addpatitem(){
            console.log('g', this.partnerShareHolderItem);
            ...
            if (!(this.partnerShareHolderItem.partnerName && this.partnerShareHolderItem.nationality
              ...
              && this.partnerShareHolderItem.domesticName)) {
          ...
          updatepatGrid(k: number) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    this.partnerShareHolderItems[k].representativeName = this.partnerShareHolderItem?.representativeName;
                    this.partnerShareHolderItems[k].domesticName = this.partnerShareHolderItem?.domesticName;
