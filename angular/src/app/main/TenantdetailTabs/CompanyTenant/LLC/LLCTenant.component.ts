...
@Component({
    selector: 'LLCTenant',
    templateUrl: './LLCTenant.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class LLCTenantComponent extends AppComponentBase {
    ...
    ngOnInit() {
        ...
        this.tenants.constitutionType = 'Limited Liability Company';
    ...
    this.Documentitems.splice(index, 1);
          ...
          addpatitem(){
            if (!(this.partnerShareHolderItem.partnerName && this.partnerShareHolderItem.nationality
              ...
              && this.partnerShareHolderItem.profitShare && this.partnerShareHolderItem.capitalAmount)) {
