...
@Component({
    selector: 'GovernmentTenant',
    templateUrl: './GovernmentTenant.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class GovernmentTenantComponent extends AppComponentBase {
    ...
    ngOnInit() {
        ...
        this.tenants.constitutionType = 'Government';
    ...
    getdesignationDropdown() {
        this._designationServiceProxy.getAll('', '', '', '', undefined, undefined, undefined, 200)
        .subscribe(result => {
...
additem(){
    if (!(this.Documentitem.documentId && this.Documentitem.documentNumber && this.Documentitem.registrationDate
   ...
   deleteItem(index: number) {
    this.Documentitems.splice(index, 1);
          ...
          addpatitem(){
            if (!(this.partnerShareHolderItem.partnerName && this.partnerShareHolderItem.nationality
               && this.partnerShareHolderItem.designation
              && this.partnerShareHolderItem.representativeName && this.partnerShareHolderItem.capitalShare
            ...
            if (this.partnerShareHolderItems.length > 0) {
                for (let k = 0; k < this.partnerShareHolderItems.length; k++) {
                    if ((this.partnerShareHolderItems[k].partnerName === this.partnerShareHolderItem.partnerName)
                    && ((this.partnerShareHolderItems[k].representativeName === this.partnerShareHolderItem.representativeName))) {
          ...
          updatepatGrid(k: number) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    this.partnerShareHolderItems[k].constitutionName = this.partnerShareHolderItem?.constitutionName;
                    this.partnerShareHolderItem = new CreateOrEditTenantShareHoldersDto();
                } else {
                    this.partnerShareHolderItems.push(this.partnerShareHolderItem);
                    this.partnerShareHolderItem = new CreateOrEditTenantShareHoldersDto();
