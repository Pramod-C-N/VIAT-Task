...
@Component({
    selector: 'LLPTenant',
    templateUrl: './LLPTenant.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class LLPTenantComponent extends AppComponentBase {
    ...
    ngOnInit() {
        ...
        this.tenants.constitutionType = 'Limited Liability Partnership';
    ...
    show(tenantId: number): void {
        ...
        this._tenantbasicdetailsServiceProxy.getTenantpartnerinfoById(tenantId).subscribe((patdata) => {
            for (let i = 0; i < patdata.length; i++) {
                ...
                this.partnerShareHolderItem.nationality = patdata[i].nationality1;
    ...
    updatepatGrid(k: number) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                this.partnerShareHolderItems[k].designation = this.partnerShareHolderItem?.designation;
                this.partnerShareHolderItems[k].constitutionName = this.partnerShareHolderItem?.designation;
                this.partnerShareHolderItems[k].representativeName = this.partnerShareHolderItem?.designation;
