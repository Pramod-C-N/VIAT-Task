...
import{ SectorServiceProxy,ConstitutionServiceProxy,GetConstitutionForViewDto} from  '@shared/service-proxies/service-proxies'
...
export class LLCComponent extends AppComponentBase {
  @Input() id : number;
  ...
  isSaving: boolean;
  basicForm: FormGroup;
  loadllcdt:boolean=false;
  loadllcadd:boolean=false;
  loadllcReg:boolean=false;
  loadllcPartInf:boolean=false;
  tenantForm() {
...
this._masterConstitutionServiceProxy.getAll("","","",undefined,undefined,undefined,undefined,undefined)
 .subscribe(result => {
   ...
   getTitle() {
     ...
     this.customer.constitutionType = 'Limited Liability Company'
  ...
  async additem() {
   ...
   loadgeneral(){
    this.loadllcdt=true;
    this.loadllcadd=false;
    this.loadllcReg=false;
    this.loadllcPartInf=false;
   }
   loadAdd(){
    this.loadllcdt=false;
    this.loadllcadd=true;
    this.loadllcReg=false;
    this.loadllcPartInf=false;   }
   loadReg(){
    this.loadllcdt=false;
    this.loadllcadd=false;
    this.loadllcReg=true;
    this.loadllcPartInf=false;
   }
   loadPartnInfo(){
    this.loadllcdt=false;
