...
export class ForeignComponent extends AppComponentBase {
  ...
  tenantForm() {
    this.basicForm = this.fb.group({
      ...
      NameOfLeagalRep: ['', Validators.required]
    });
  }
  isFormValid() {
  ...
  create() {
    ...
    this.customer.constitutionType = 'Foreign Branch'
    ...
    this.foreign.legalRepresentative = this.basicForm.get('NameOfLeagalRep').value || " ";
