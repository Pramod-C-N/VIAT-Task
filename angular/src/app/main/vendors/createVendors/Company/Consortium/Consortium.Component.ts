...
export class ConsortiumComponent extends AppComponentBase {
  @Input() id: number;
  ...
  show(CustomerId?: number): void {
    if (!CustomerId) {
      ...
      this._customerServiceProxy.getVendorForEdit(CustomerId).subscribe((result) => {
        ...
        this.customer.constitutionType = 'Consortium'
  ...
  loadgeneral() {
    this.loadConsortiumdt = true;
    this.loadConsortiumadd = false;
    this.loadConsortiumReg = false;
    this.loadConsortiumPartInf = false;
  }
  loadAdd() {
    this.loadConsortiumdt = false;
    this.loadConsortiumadd = true;
    this.loadConsortiumReg = false;
    this.loadConsortiumPartInf = false;
  }
  loadReg() {
  ...
  loadPartnInfo() {
    ...
    this.loadConsortiumadd = false;
    this.loadConsortiumReg = false;
    this.loadConsortiumPartInf = true;
  }
  updateGrid(k: number) {
    Swal.fire({
