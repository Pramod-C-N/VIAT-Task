...
@Component({
  templateUrl: './integratedsalesInvoiceFileUpload.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()],
  styleUrls: ['./integratedsalesInvoiceFileUpload.component.less'],
})
export class IntegratedSalesInvoiceFileUploadComponent extends AppComponentBase {
  ...
  constructor(
    ...
    super(injector);
    this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/IntegrationFileUpload/ImportFromExcel';
  }
