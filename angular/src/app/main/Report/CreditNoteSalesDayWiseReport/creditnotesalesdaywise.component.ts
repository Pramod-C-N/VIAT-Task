...
@Component({
    templateUrl: './creditnotesalesdaywise.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class CreditNoteSalesDaywiseReportComponent extends AppComponentBase {
    ...
    downloadExcel(li: any[]) {
        this._SalesDaywiseProxy
            .getCreditDaywiseToExcel(
                ...
                this.parseDate(this.dateRange[1].toString()),
                this.code,
                'CreditNote(Sales)DaywiseReport',
                this.tenantName,
                false
            )
            .subscribe((result) => {
