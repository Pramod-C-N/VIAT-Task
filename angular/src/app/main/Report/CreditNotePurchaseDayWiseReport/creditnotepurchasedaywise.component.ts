...
@Component({
  templateUrl: './creditnotepurchasedaywise.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()],
})

export class CreditNotePurchaseDaywiseReportComponent extends AppComponentBase {
...
getCreditNotePurchaseDaywiseReport(){
    this.ResetData();
    this.isdisable=true;
      this._SalesDaywiseProxy.getCreditPurchaseDaywiseReport(this.parseDate(this.dateRange[0].toString()),this.parseDate(this.dateRange[1].toString()))
  ...
  //     console.log(grouped);
      ...
      this.invoices.forEach(element => {
          ...
          this.count+=parseInt(element.invoicecount);
  ...
  removeFooter(li:any[]):any[]{
   ...
   downloadExcel(li:any[]){
    this._SalesDaywiseProxy.getDaywiseCreditPurchaseToExcel(this.parseDate(this.dateRange[0].toString()),this.parseDate(this.dateRange[1].toString()),'CreditNote(Purchase)DaywiseReport',this.tenantName,false)
.subscribe((result) => {
