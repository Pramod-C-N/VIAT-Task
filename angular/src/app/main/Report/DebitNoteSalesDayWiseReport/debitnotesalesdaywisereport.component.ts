...
@Component({
    templateUrl: './debitnotesalesdaywisereport.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class DebitNoteSalesDaywiseReportComponent extends AppComponentBase {
