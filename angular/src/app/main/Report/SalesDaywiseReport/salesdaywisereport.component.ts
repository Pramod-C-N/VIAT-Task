...
@Component({
  templateUrl: './salesDaywiseReport.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()],
})

export class SalesDaywiseReportComponent extends AppComponentBase {
...
// {field:"healthCare",header:"Private health care/Private Education/First House Sale to"},
...
ResetData() {
  ...
  getSalesDaywiseReport(){
    this.ResetData();
    this.isdisable=true;
      this._SalesDaywiseProxy.getSalesDayWiseReport(this.parseDate(this.dateRange[0].toString()),this.parseDate(this.dateRange[1].toString()))
  ...
  removeFooter(li:any[]):any[]{
   ...
   downloadExcel(li:any[]){
    this._SalesDaywiseProxy.getSalesDaywiseToExcel(this.parseDate(this.dateRange[0].toString()),this.parseDate(this.dateRange[1].toString()),'SalesDaywiseReport',this.tenantName,false)
    .subscribe((result) => {
