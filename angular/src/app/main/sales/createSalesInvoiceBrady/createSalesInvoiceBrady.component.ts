...
import { Component, ElementRef, Injector, Input, ViewEncapsulation } from '@angular/core';
...
import {
    ...
    CreateOrEditOrganisationTypeDto,
    CustomersesServiceProxy,
    SalesInvoicePartyDto,
    DraftsServiceProxy,
    CreateOrEditDraftDto,
} from '@shared/service-proxies/service-proxies';
import { AppComponentBase } from '@shared/common/app-component-base';
import { appModuleAnimation } from '@shared/animations/routerTransition';
import { filter as _filter, sum } from 'lodash-es';
...
@Component({
    templateUrl: './createSalesInvoiceBrady.component.html',
    styleUrls: ['./createSalesInvoiceBrady.component.css'],
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class CreateSalesInvoiceBradyComponent extends AppComponentBase {
    otherChargesList$ = new BehaviorSubject([
        'Freight',
        'Handling Charges',
        'Packing Charges',
    ...
    delivery: CreateOrEditSalesInvoicePartyDto = new CreateOrEditSalesInvoicePartyDto();
    deliverylang: CreateOrEditSalesInvoicePartyDto = new CreateOrEditSalesInvoicePartyDto();
    ...
    deliveryAddress: CreateOrEditSalesInvoiceAddressDto = new CreateOrEditSalesInvoiceAddressDto();
    deliveryAddressLang: CreateOrEditSalesInvoiceAddressDto = new CreateOrEditSalesInvoiceAddressDto();
    ...
    language: number = 1;
    deliveryfields: boolean=true;
    additionalfields:boolean=true;
    ...
    checkautocomplete() {
        if (this.invoiceItems.length > 0 && this.address.countryCode != null && this.address.countryCode != undefined) {
            this.notify.error('Cannot Change Country Adding Item');
    ...
    getdefault() {
        ...
        if (this.invoiceItems.length > 0 && this.address.countryCode != null && this.address.countryCode != undefined) {
            this.notify.error('Cannot Change Currency After Adding Item');
            this.isAutoCompleteDisabled = true;
        }
    ...
    countrychanges() {
        ...
        if (this.basicForm.get('nationality').value !== 'SA' && this.address.countryCode !== 'SA') {
            ...
            this.basicForm.get('pin').setValidators([Validators.required, Validators.pattern('^[0-9]*$')]);
            ...
            this.basicForm.get('city').setValidators([Validators.required, Validators.pattern('[a-zA-Z][a-zA-Z ]+')]);
            this.basicForm.get('street').addValidators([Validators.required]);
    ...
    ngOnInit() {
        ...
        this._tenantConfigurations.getTenantConfigurationByTransactionType('General').subscribe((e) => {
            ...
            if (e?.tenantConfiguration?.emailJson) {
                this.basicForm.get('Email').addValidators([Validators.required]);
                this.enableemail=true;
            }
            else
            {
                this.basicForm.get('Email').addValidators([]);
                this.enableemail=false;

            }
            this.basicForm.get('Email').updateValueAndValidity();
    ...
    create() {
        ...
        this.delivery.contactPerson = new CreateOrEditSalesInvoiceContactPersonDto();
        ...
        this.delivery_customerlang.contactPerson = new CreateOrEditSalesInvoiceContactPersonDto();
        this.delivery_customerlang.address = new CreateOrEditSalesInvoiceAddressDto();
        //--------------------brady-----------------------------
    }
    ...
    fillDummy() {
        ...
        //!this.invoice.billingReferenceId ? " " : this.invoice.billingReferenceId
    ...
    async save() {
        ...
        if(this.delivery_customer != null && this.delivery_customerlang !=  null && 
            this.delivery_customer != undefined && this.delivery_customerlang !=  undefined)
        {
        this.adddelivery();
        }
        ...
        if (this.isFormValid()) {
            ...
            if(this.additional_info != null && this.additional_info !=  null && 
                this.additional_info != undefined && this.additional_info !=  undefined)
            {
            ...
            obj.source="UI"
            obj.invoiceTypeCode="388"
            console.log(obj,"draftObject")
            console.log(this.generateDraft)
            ...
            if (this.additionalDetailsModel != null || this.deliveryDetailsModel.length != null) {
    ...
    adddelivery() {
        ...
        this.delivery.crNumber=this.delivery_customer.crNumber;
        ...
        if (this.multilanguage == true) {
            ...
            this.deliverylang.crNumber = this.delivery_customerlang.crNumber;
    ...
    checkValue(takedatafromcus) {
        if (takedatafromcus == true) {
            ...
            // })
            this.deliveryFormGroup.get('crNumber').setValue(this.customer.customerId);
            ...
            this.deliveryFormGroup.get('crNumber').setValue('');
    ...
    editCharges(index: number) {
        ...
        let edited = this.invoiceCharges[index];
        let temp = this.otherChargesList$.getValue();
        temp.push(edited.name);
        this.otherChargesList$.next(temp);
        this.invoiceCharges.splice(index, 1);
        this.calculategridTotalOtherCharge();
    }

    deleteCharges(index: number) {
        let deleted = this.invoiceCharges.splice(index, 1);
        let temp = this.otherChargesList$.getValue();
        temp.push(deleted[0].name);
        this.otherChargesList$.next(temp);
        this.calculategridTotalOtherCharge();
    }
