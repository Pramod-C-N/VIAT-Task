...
import {
    ...
    CreateOrEditCreditNotePartyDto,
    CreateOrEditSalesInvoiceItemDto,
    CreateOrEditCreditNoteSummaryDto,
    CreateOrEditCreditNoteVATDetailDto,
    CreateOrEditCreditNoteDiscountDto,
    ...
    CreateOrEditCreditNoteAddressDto,
...
@Component({
    templateUrl: './createCreditNotebrady.component.html',
    styleUrls: ['./createCreditNotebrady.component.css'],
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class CreateCreditNotebradyComponent extends AppComponentBase {
    public deliveryFormGroup: FormGroup;
    public additionalFormGroup: FormGroup;
    public salesadditionalFormGroup: FormGroup;
    ...
    salesadditionalDetailsModel: any = null;
    multilanguage = false;
    ...
    delivery_customer: CreateOrEditCreditNotePartyDto = new CreateOrEditCreditNotePartyDto();
    delivery_customerlang: any = {};
    delivery: CreateOrEditCreditNotePartyDto = new CreateOrEditCreditNotePartyDto();
    deliverylang: CreateOrEditCreditNotePartyDto = new CreateOrEditCreditNotePartyDto();
    deliveryAddress: CreateOrEditCreditNoteAddressDto = new CreateOrEditCreditNoteAddressDto();
    deliveryAddressLang: CreateOrEditCreditNoteAddressDto = new CreateOrEditCreditNoteAddressDto();
    ...
    ngOnInit(): void {
        ...
        //     if (e?.tenantConfiguration?.additionalFieldsJson) {
        //         this.salesadditionalDetailsModel = JSON.parse(e.tenantConfiguration.additionalFieldsJson);
        //         this.salesadditionalFormGroup = this.buildForm(this.additionalDetailsModel, this.additionalDetailFields);
        //     }
        // });
    ...
    copyFormGroupValues(salesadditionalFormGroup: FormGroup, additionalFormGroup: FormGroup) {
        for (const controlName of Object.keys(additionalFormGroup.controls)) {
            if (salesadditionalFormGroup.get(controlName) && additionalFormGroup.get(controlName)) {
                additionalFormGroup.get(controlName).setValue(salesadditionalFormGroup.get(controlName).value);
            }
        }
    }
    ...
    create() {
        ...
        this.delivery_customer.address = new CreateOrEditCreditNoteAddressDto();
        this.delivery_customerlang.contactPerson = new CreateOrEditCreditNoteContactPersonDto();
        this.delivery_customerlang.address = new CreateOrEditCreditNoteAddressDto();
        //--------------------brady-----------------------------
    }
    ...
    deleteItem(index: number) {
        ...
        this.vatDetail = new CreateOrEditCreditNoteVATDetailDto();
        this.calculateInvoiceSummary(this.invoiceSummary, this.invoiceItems);
    }
                    ...
                    if (result.isConfirmed) {
                        if (this.generateDraft) {
                            this._draftServiceProxy.createDraft(obj).subscribe((result) => {
                                ...
                                this.editMode = false;
                                this.isSaving = false;
                                this._router.navigate(['/app/main/transactions'], {
                                    state: { tabvaule: 'Credit Note' },
                                });
                            });
                        } else {
