...
{
    public partial class Added_PurchaseEntryAddress : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseEntryAddress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseEntryAddress", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseEntryAddress_TenantId",
                table: "PurchaseEntryAddress",
                column: "TenantId");
        }
