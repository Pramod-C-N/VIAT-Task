...
{
    public partial class Added_PurchaseCreditNoteSummary : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseCreditNoteSummary",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNoteSummary", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNoteSummary_TenantId",
                table: "PurchaseCreditNoteSummary",
                column: "TenantId");
        }
