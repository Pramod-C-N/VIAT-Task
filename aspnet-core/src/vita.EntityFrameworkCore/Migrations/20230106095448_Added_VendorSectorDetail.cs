...
{
    public partial class Added_VendorSectorDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "VendorSectorDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorSectorDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_VendorSectorDetail_TenantId",
