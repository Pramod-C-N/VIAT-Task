...
{
    public partial class Added_PurchaseCreditNoteParty : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseCreditNotePartiy",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNotePartiy", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNotePartiy_TenantId",
