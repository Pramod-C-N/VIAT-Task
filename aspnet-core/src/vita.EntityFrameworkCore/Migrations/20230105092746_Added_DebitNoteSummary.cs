...
{
    public partial class Added_DebitNoteSummary : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DebitNoteSummary",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DebitNoteSummary", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DebitNoteSummary_TenantId",
