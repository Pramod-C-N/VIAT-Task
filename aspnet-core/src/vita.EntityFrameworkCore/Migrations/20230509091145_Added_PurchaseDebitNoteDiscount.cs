...
{
    public partial class Added_PurchaseDebitNoteDiscount : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseDebitNoteDiscount",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseDebitNoteDiscount", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDebitNoteDiscount_TenantId",
                table: "PurchaseDebitNoteDiscount",
                column: "TenantId");
        }
