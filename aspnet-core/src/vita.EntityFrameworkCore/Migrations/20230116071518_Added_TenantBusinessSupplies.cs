...
{
    public partial class Added_TenantBusinessSupplies : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TenantBusinessSupplies",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantBusinessSupplies", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_TenantBusinessSupplies_TenantId",
