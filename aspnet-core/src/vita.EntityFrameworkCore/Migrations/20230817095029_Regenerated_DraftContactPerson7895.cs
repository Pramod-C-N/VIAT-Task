...
{
    public partial class Regenerated_DraftContactPerson7895 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DraftContactPerson",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DraftContactPerson", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DraftContactPerson_TenantId",
