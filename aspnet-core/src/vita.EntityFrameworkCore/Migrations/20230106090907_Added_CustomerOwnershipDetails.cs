...
{
    public partial class Added_CustomerOwnershipDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CustomerOwnershipDetails",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerOwnershipDetails", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerOwnershipDetails_TenantId",
