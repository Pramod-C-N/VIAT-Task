...
{
    public partial class Added_CreditNoteAddress : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CreditNoteAddress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditNoteAddress", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CreditNoteAddress_TenantId",
