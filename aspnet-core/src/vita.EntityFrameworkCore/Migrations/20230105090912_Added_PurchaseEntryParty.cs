...
{
    public partial class Added_PurchaseEntryParty : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseEntryParty",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseEntryParty", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseEntryParty_TenantId",
