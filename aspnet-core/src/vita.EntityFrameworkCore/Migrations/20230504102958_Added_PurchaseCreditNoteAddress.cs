...
{
    public partial class Added_PurchaseCreditNoteAddress : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseCreditNoteAddress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNoteAddress", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNoteAddress_TenantId",
                table: "PurchaseCreditNoteAddress",
                column: "TenantId");
        }
