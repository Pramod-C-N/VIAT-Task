...
{
    public partial class Added_PurchaseCreditNoteItem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNoteItem", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNoteItem_TenantId",
                table: "PurchaseCreditNoteItem",
                column: "TenantId");
        }
