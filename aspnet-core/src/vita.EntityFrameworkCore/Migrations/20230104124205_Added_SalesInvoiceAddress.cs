...
{
    public partial class Added_SalesInvoiceAddress : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SalesInvoiceAddress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesInvoiceAddress", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceAddress_TenantId",
