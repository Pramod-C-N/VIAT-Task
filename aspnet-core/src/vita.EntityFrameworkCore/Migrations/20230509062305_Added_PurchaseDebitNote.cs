...
{
    public partial class Added_PurchaseDebitNote : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseDebitNote", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDebitNote_TenantId",
                table: "PurchaseDebitNote",
                column: "TenantId");
        }
