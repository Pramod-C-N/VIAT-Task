...
{
    public partial class Added_PurchaseDebitNoteSummary : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseDebitNoteSummary",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseDebitNoteSummary", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDebitNoteSummary_TenantId",
                table: "PurchaseDebitNoteSummary",
                column: "TenantId");
        }
