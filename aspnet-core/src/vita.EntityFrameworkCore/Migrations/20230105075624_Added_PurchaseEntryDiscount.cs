...
{
    public partial class Added_PurchaseEntryDiscount : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseEntryDiscount",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseEntryDiscount", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseEntryDiscount_TenantId",
