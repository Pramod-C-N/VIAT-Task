...
{
    public partial class Added_CreditNoteContactPerson : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CreditNoteContactPerson",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditNoteContactPerson", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CreditNoteContactPerson_TenantId",
