...
{
    public partial class Added_SalesInvoiceParty : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SalesInvoiceParty",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesInvoiceParty", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceParty_TenantId",
