...
{
    public partial class Regenerated_DraftPaymentDetail9949 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DraftPaymentDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DraftPaymentDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DraftPaymentDetail_TenantId",
