...
{
    public partial class Regenerated_DraftVATDetail7084 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DraftVATDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DraftVATDetail_TenantId",
                table: "DraftVATDetail",
                column: "TenantId");
        }
