...
{
    public partial class Added_PurchaseCreditNoteDiscount : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseCreditNoteDiscount",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNoteDiscount", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNoteDiscount_TenantId",
