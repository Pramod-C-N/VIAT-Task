...
{
    public partial class Added_PurchaseEntryItem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseEntryItem", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseEntryItem_TenantId",
                table: "PurchaseEntryItem",
                column: "TenantId");
        }
