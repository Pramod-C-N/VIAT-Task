...
{
    public partial class Added_CreditNoteVATDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CreditNoteVATDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditNoteVATDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CreditNoteVATDetail_TenantId",
