...
{
    public partial class Added_CustomerSectorDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CustomerSectorDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerSectorDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerSectorDetail_TenantId",
