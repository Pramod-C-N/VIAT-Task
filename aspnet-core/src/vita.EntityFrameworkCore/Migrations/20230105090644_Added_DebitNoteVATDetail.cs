...
{
    public partial class Added_DebitNoteVATDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DebitNoteVATDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DebitNoteVATDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DebitNoteVATDetail_TenantId",
