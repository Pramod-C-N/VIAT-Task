...
{
    public partial class Added_PurchaseCreditNoteVATDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseCreditNoteVATDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseCreditNoteVATDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseCreditNoteVATDetail_TenantId",
                table: "PurchaseCreditNoteVATDetail",
                column: "TenantId");
        }
