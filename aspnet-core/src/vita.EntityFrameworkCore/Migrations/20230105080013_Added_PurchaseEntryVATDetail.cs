...
{
    public partial class Added_PurchaseEntryVATDetail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PurchaseEntryVATDetail",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseEntryVATDetail", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseEntryVATDetail_TenantId",
                table: "PurchaseEntryVATDetail",
                column: "TenantId");
        }
