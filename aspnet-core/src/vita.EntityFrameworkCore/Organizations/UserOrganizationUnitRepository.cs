...
{
    public class UserOrganizationUnitRepository : vitaRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<vitaDbContext> dbContextProvider)
