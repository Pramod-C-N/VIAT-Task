...
{
    public class SubscriptionPaymentRepository : vitaRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<vitaDbContext> dbContextProvider)
