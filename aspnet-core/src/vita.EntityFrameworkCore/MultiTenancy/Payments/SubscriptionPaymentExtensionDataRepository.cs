...
using vita.EntityFrameworkCore.Repositories;

namespace vita.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : vitaRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<vitaDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
