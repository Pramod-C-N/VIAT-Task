...
using vita.Core.Base;
using vita.Core.Extensions;
using vita.Dto;
using vita.Types;

namespace vita.Queries
{
    public class OrganizationUnitQuery : vitaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
