...
using vita.Url;
using vita.Web.Public.Startup;
using vita.Web.Session;

namespace vita.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : vitaViewComponent
    {
