...
namespace vita.Web.Public.Startup
{
    [DependsOn(
        typeof(vitaWebCoreModule)
    )]
    public class vitaWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public vitaWebFrontEndModule(IWebHostEnvironment env, vitaEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(vitaWebFrontEndModule).GetAssembly());
        }
    }
}
