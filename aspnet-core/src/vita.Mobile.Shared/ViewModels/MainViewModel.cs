...
using vita.Commands;
using vita.Core.Threading;
using vita.Models.NavigationMenu;
using vita.Services.Navigation;
...
using vita.ApiClient;
using vita.Controls;
using vita.Dto;
using vita.Extensions;
using vita.Localization;
using vita.UI;
using vita.UI.Assets;
using vita.Views;
using DependencyResolver = vita.Core.Dependency.DependencyResolver;
...
namespace vita.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "vita";
