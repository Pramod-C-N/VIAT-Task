...
{
    public abstract class SalesFileUploadBase : vitaControllerBase
    {
        ...
        public async Task<JsonResult> ImportFromExcel(DateTime? fromdate, DateTime? todate)
        {
            try
            {
                ...
                await BackgroundJobManager.EnqueueAsync<ImportSalesInvoiceToExcelJob, ImportUsersFromExcelJobArgs>(new ImportUsersFromExcelJobArgs
                {
                    TenantId = tenantId,
