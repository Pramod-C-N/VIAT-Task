...
{
    public class CreditNoteFileUploadBase : vitaControllerBase
    {
        protected readonly IBinaryObjectManager BinaryObjectManager;
        protected readonly IBackgroundJobManager BackgroundJobManager;

        protected CreditNoteFileUploadBase(
        ...
        public async Task<JsonResult> ImportFromExcel(DateTime? fromdate, DateTime? todate)
        {
            try
            {
                ...
                await BackgroundJobManager.EnqueueAsync<ImportCreditNoteFileToExcelJob, ImportUsersFromExcelJobArgs>(new ImportUsersFromExcelJobArgs
                {
                    TenantId = tenantId,
