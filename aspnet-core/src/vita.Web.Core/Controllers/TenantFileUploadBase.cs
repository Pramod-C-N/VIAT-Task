...
using vita.ImportTenantFileupload;

namespace vita.Web.Controllers
{
    public class TenantFileUploadBase : vitaControllerBase
    {
        protected readonly IBinaryObjectManager BinaryObjectManager;
        protected readonly IBackgroundJobManager BackgroundJobManager;

        protected TenantFileUploadBase(
        ...
        public async Task<JsonResult> ImportFromExcel()
        {
            ...
            try
            {
                ...
                await BackgroundJobManager.EnqueueAsync<ImportTenantFileToExcelJob, ImportUsersFromExcelJobArgs>(new ImportUsersFromExcelJobArgs
                {
                    TenantId = tenantId,
