...
namespace vita.Web.Authentication.JwtBearer
{
    public class vitaAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public vitaAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
