...
{
    public class vitaMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public vitaMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(vitaConsts.LocalizationSourceName, name);
        }
    }
}