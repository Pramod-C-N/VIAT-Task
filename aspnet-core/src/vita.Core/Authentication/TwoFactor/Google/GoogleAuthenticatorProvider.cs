...
namespace vita.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : vitaServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("vita", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
