...
{
    public  class ImportPaymentListExcelDataReader : NpoiExcelImporterBase<CreateOrEditImportBatchDataDto>, IImportPaymentListExcelDataReader
    {
...
"ZM","ZW","UK" };
        ...
        public ImportPaymentListExcelDataReader(ILocalizationManager localizationManager)
        {
