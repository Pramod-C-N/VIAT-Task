...
using vita.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace vita.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : vitaAppServiceBase, IDashboardCustomizationAppService
    {
