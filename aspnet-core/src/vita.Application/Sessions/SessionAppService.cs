...
{
    public class SessionAppService : vitaAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = vitaConsts.Currency,
                        CurrencySign = vitaConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = vitaConsts.AllowTenantsToChangeEmailSettings,
