...
using vita.Auditing.Exporting;
using vita.Authorization;
using vita.Authorization.Users;
using vita.Dto;
using vita.EntityHistory;
using EntityHistoryHelper = vita.EntityHistory.EntityHistoryHelper;

namespace vita.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : vitaAppServiceBase, IAuditLogAppService
    {
