...
using vita.ImportTrialBalanceFileupload.Importing;

namespace vita.ImportTrialBalanceFileupload.Importing
{
    public  class ImportTrialBalanceListExcelDataReader : NpoiExcelImporterBase<CreateOrEditImportBatchDataDto>, IImportTrialBalanceListExcelDataReader
    {
...
"ZM","ZW","UK" };
        ...
        public ImportTrialBalanceListExcelDataReader(ILocalizationManager localizationManager)
        {
        ...
        private CreateOrEditImportBatchDataDto ProcessExcelRow(ISheet worksheet, int row)
        {
            ...
            try
            {
              ...
              //  data.CapitalInvestmentDate = GetOptionalValueFromRowOrNull(worksheet, row, 22, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
