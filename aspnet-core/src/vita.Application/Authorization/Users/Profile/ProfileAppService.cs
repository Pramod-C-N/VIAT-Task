...
using vita.Authorization.Users.Profile.Cache;
...
namespace vita.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : vitaAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("vita",
