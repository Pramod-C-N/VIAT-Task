...
namespace vita.ImportCustomerFileupload.Importing
{
    public  class ImportCustomerListExcelDataReader : NpoiExcelImporterBase<CreateOrEditImportBatchDataDto>, IImportCustomerListExcelDataReader
    {
...
"ZM","ZW","UK" };
        ...
        public ImportCustomerListExcelDataReader(ILocalizationManager localizationManager)
        {
        ...
        private CreateOrEditImportBatchDataDto ProcessExcelRow(ISheet worksheet, int row)
        {
            ...
            try
            {
                ...
                data.BuyerName = GetOptionalValueFromRowOrNull(worksheet, row, 1, exceptionMessage, nameof(data.BuyerName), CellType.String, nullCheck: true);
                data.OrgType= GetOptionalValueFromRowOrNull(worksheet, row, 2, exceptionMessage, nameof(data.BuyerName), CellType.String, nullCheck: true);
                data.BuyerCountryCode = GetOptionalValueFromRowOrNull(worksheet, row, 3, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.IssueDate = Convert.ToDateTime(GetRequiredDateValueFromRowOrNull(worksheet, row, 4, nameof(data.IssueDate), exceptionMessage, nullCheck: true));
                data.TotalTaxableAmount = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 5, exceptionMessage, nameof(data.LineNetAmount), CellType.String, nullCheck: true));
                data.InvoiceCurrencyCode = GetRequiredValueFromRowOrNull(worksheet, row, 6, nameof(data.InvoiceCurrencyCode), exceptionMessage, nullCheck: true);
                data.PaymentMeans= GetOptionalValueFromRowOrNull(worksheet, row, 7, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.ExchangeRate = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 8, exceptionMessage, nameof(data.LineNetAmount), CellType.String, nullCheck: true));
                data.LineAmountInclusiveVAT = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 9, exceptionMessage, nameof(data.LineAmountInclusiveVAT), CellType.String, nullCheck: true));
                data.LedgerHeader =  GetRequiredValueFromRowOrNull(worksheet, row, 10, nameof(data.InvoiceCurrencyCode), exceptionMessage, nullCheck: true);
                data.NatureofServices= GetOptionalValueFromRowOrNull(worksheet, row, 11, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.ItemName= GetOptionalValueFromRowOrNull(worksheet, row, 12, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.PlaceofSupply= GetOptionalValueFromRowOrNull(worksheet, row, 13, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.AffiliationStatus= GetOptionalValueFromRowOrNull(worksheet, row, 14, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.PurchaseNumber= GetOptionalValueFromRowOrNull(worksheet, row, 15, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.OrignalSupplyDate = Convert.ToDateTime(GetRequiredDateValueFromRowOrNull(worksheet, row, 16, nameof(data.OrignalSupplyDate), exceptionMessage, nullCheck: true));
                data.ReferenceInvoiceAmount = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 17, exceptionMessage, nameof(data.GrossPrice), CellType.String, nullCheck: true));
                data.PaymentTerms= GetOptionalValueFromRowOrNull(worksheet, row, 18, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.PerCapitaHoldingForiegnCo = GetOptionalValueFromRowOrNull(worksheet, row, 19, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.CapitalInvestedbyForeignCompany = GetOptionalValueFromRowOrNull(worksheet, row, 20, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.CapitalInvestmentCurrency = GetOptionalValueFromRowOrNull(worksheet, row, 21, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
                data.CapitalInvestmentDate = Convert.ToDateTime(GetRequiredDateValueFromRowOrNull(worksheet, row, 22, nameof(data.CapitalInvestmentDate), exceptionMessage, nullCheck: true));

              //  data.VendorCostitution = GetOptionalValueFromRowOrNull(worksheet, row, 23, exceptionMessage, nameof(data.BuyerCountryCode), CellType.String);
