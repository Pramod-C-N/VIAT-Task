...
{
    internal class SalesInvoiceListExcelDataReader : NpoiExcelImporterBase<CreateOrEditImportBatchDataDto>, ISalesInvoiceListExcelDataReader
    {
        private readonly ILocalizationSource _localizationSource;
        public string[] uom = { "LTRS", "PCS", "NOS", "GMS", "KGS", "PACKS" };
        public string[] invoiceTypes = { "NOMINAL","SIMPLIFIED","STANDARD","SUMMARY","SELFBILLED","THIRDPARTY","EXPORT"};
...
"ZM","ZW","UK" };
        ...
        public SalesInvoiceListExcelDataReader(ILocalizationManager localizationManager)
        {
        ...
        //    try
        //    {
        //        if (data.LineAmountInclusiveVAT > 1000) //Standard Invoices
        //        {
        ...
        //        else
        //        {
        //            data.BuyerName = GetOptionalValueFromRowOrNull(worksheet, row, 12, exceptionMessage, nameof(data.BuyerName), CellType.String, nullCheck: false);

        //        }
        //        data.InvoiceType = GetRequiredValueFromRowOrNull(worksheet, row, 0, nameof(data.InvoiceType), exceptionMessage, nullCheck: true);
        //        data.TransType = GetRequiredValueFromRowOrNull(worksheet, row, 1, nameof(data.InvoiceType), exceptionMessage, nullCheck: true);
        //        data.IRNNo = GetOptionalValueFromRowOrNull(worksheet, row, 2, exceptionMessage, nameof(data.IRNNo), CellType.String);
        //        data.InvoiceNumber = GetRequiredValueFromRowOrNull(worksheet, row, 3, nameof(data.InvoiceNumber), exceptionMessage, nullCheck: true);
        ...
        //        data.IssueTime = GetRequiredValueFromRowOrNull(worksheet, row, 5, nameof(data.IssueTime), exceptionMessage, nullCheck: true);
        ...
        //        data.PurchaseOrderId = GetOptionalValueFromRowOrNull(worksheet, row, 7, exceptionMessage, nameof(data.PurchaseOrderId), CellType.String);
        //        data.ContractId = GetOptionalValueFromRowOrNull(worksheet, row, 8, exceptionMessage, nameof(data.ContractId), CellType.String);
        //        data.SupplyDate = Convert.ToDateTime(GetRequiredDateValueFromRowOrNull(worksheet, row, 9, nameof(data.SupplyDate), exceptionMessage, nullCheck: true));
        //        data.SupplyEndDate = Convert.ToDateTime(GetRequiredDateValueFromRowOrNull(worksheet, row, 10, nameof(data.SupplyEndDate), exceptionMessage));
        ...
        //        data.UOM = GetOptionalValueFromRowOrNull(worksheet, row, 19, exceptionMessage, nameof(data.UOM), CellType.String, nullCheck: true);
        ...
        //        //--------------additional fields---------------------------
        //        data.AdvanceRcptAmtAdjusted = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 31, exceptionMessage, nameof(data.AdvanceRcptAmtAdjusted), CellType.String, nullCheck: true));
        //        data.VatOnAdvanceRcptAmtAdjusted = Convert.ToDecimal(GetOptionalDecimalValueFromRowOrNull(worksheet, row, 32, exceptionMessage, nameof(data.VatOnAdvanceRcptAmtAdjusted), CellType.String, nullCheck: true));
        //        data.AdvanceRcptRefNo = GetOptionalValueFromRowOrNull(worksheet, row, 33, exceptionMessage, nameof(data.AdvanceRcptRefNo), CellType.String);
        //        data.PaymentMeans = GetOptionalValueFromRowOrNull(worksheet, row, 34, exceptionMessage, nameof(data.PaymentMeans), CellType.String);
        //        data.PaymentTerms = GetOptionalValueFromRowOrNull(worksheet, row, 35, exceptionMessage, nameof(data.PaymentTerms), CellType.String);
        //        data.OrgType = GetOptionalValueFromRowOrNull(worksheet, row, 36, exceptionMessage, nameof(data.OrgType), CellType.String);
        //        if (invoices.Contains(data.InvoiceNumber.ToUpper()))
        //        {
        //            exceptionMessage.Append("Duplicate Invoice number found in uploaded file;");
        //        }
        //        else
        //        {
        ...
        //            }
        //            if (!data.BuyerVatCode.EndsWith("3"))
        //            {
        //                exceptionMessage.Append("Buyer VAT Code should end with 3;");
        //            }
        ...
        //        if (!invoiceTypes.Contains(data.InvoiceType?.Replace(" ","").ToUpper()))
        //        {
        //            exceptionMessage.Append("Invalid VAT Code;");
        //        }
        ...
        //            if(data.VatCategoryCode == "Z")
        //            {
        //                if (string.IsNullOrEmpty(data.VatExemptionReasonCode))
        //                {
        //                    exceptionMessage.Append("VAT Exemption Code is required;");
