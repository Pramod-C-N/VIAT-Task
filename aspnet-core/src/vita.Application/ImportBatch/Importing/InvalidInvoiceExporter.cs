...
{
    public class InvalidInvoiceExporter : NpoiExcelExporterBase, IInvalidInvoiceExporter, ITransientDependency
    {
        ...
        public FileDto ExportToFile(List<CreateOrEditImportBatchDataDto> userListDtos)
        {
            return CreateExcelPackage(
                "InvalidInvoiceImportList.xlsx",
                excelPackage =>
                {
                    var sheet = excelPackage.CreateSheet("InvalidInvoiceImports");
