...
using vita.DynamicEntityPropertyValues.Dto;

namespace vita.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : vitaAppServiceBase, IDynamicEntityPropertyValueAppService
    {
