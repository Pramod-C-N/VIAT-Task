...
{
    public  class ImportVendorListExcelDataReader : NpoiExcelImporterBase<CreateOrEditImportBatchDataDto>, IImportVendorListExcelDataReader
    {
...
"ZM","ZW","UK" };
        ...
        public ImportVendorListExcelDataReader(ILocalizationManager localizationManager)
        {
