...
using vita.Auditing;
using vita.Authorization.Users.Password;
using vita.Configuration;
using vita.EntityFrameworkCore;
using vita.MultiTenancy;
using vita.Web.Startup.ExternalLoginInfoProviders;
...
namespace vita.Web.Startup
{
    ...
    public class vitaWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public vitaWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(vitaWebHostModule).GetAssembly());
        }
