...
using vita.MultiTenancy.HostDashboard;
...
namespace vita.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(vitaDbContext context, SubscriptionPayment subscriptionPayment)
        {
